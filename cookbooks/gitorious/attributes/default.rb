...
default[:gitorious][:host]                 = 'localhost'
default[:gitorious][:git][:url]            = "git://gitorious.org/gitorious/mainline.git"
default[:gitorious][:git][:reference]      = "master"
default[:gitorious][:support_email]        = "support@this.com"
default[:gitorious][:notification_emails]  = "support@this.com"
...
default[:gitorious][:admin][:email]        = "support@this.com"
default[:gitorious][:admin][:password]     = "password"
node[:gitorious][:authentication][:methods][:encryption] = "false"
